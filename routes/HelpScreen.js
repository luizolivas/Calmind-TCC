        ...
        <CustomGradient>
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View style={stylesHelp.contentContainer}>
                    ...
                    <HelpContentElement name="heart" color={baseColor} title="Apoio" navigationRoute="Talk" text="Quando a necessidade de compartilhar torna-se urgente, nossa seção de conversas oferece acesso rápido ao CVV (Centro de Valorização da Vida) na seção de chat online ou à possibilidade de fazer uma ligação direta. Ou se preferir confira os locais onde você pode procurar por ajuda perto de você. Priorize sua saúde mental e emocional." />
                </View>
            </ScrollView>
        </CustomGradient>
    );
